...
```elixir
def reply(client, feedback, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_list_feedback(client, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_search_feedback(client, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_get_feedback(client, feedback, opts \\ [])
```
...
```elixir
def v2_replace_feedback(client, feedback, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_reply_to_feedback(client, feedback, params \\ %{}, opts \\ [])
```
