...
```elixir
def start(client, platform, params \\ %{}, opts \\ [])
```
...
```elixir
def poll(client, platform, params \\ %{}, opts \\ [])
```
...
```elixir
def complete(client, platform, params \\ %{}, opts \\ [])
```
...
```elixir
def verify(client, platform, opts \\ [])
```
...
```elixir
def disconnect(client, platform, opts \\ [])
```
