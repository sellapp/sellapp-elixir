...
```elixir
def get(client, coupon, params \\ %{}, opts \\ [])
```
...
```elixir
def replace(client, coupon, params \\ %{}, opts \\ [])
```
...
```elixir
def update(client, coupon, params \\ %{}, opts \\ [])
```
...
```elixir
def delete(client, coupon, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_list_coupons(client, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_create_coupon(client, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_search_coupons(client, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_get_coupon(client, coupon, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_replace_coupon(client, coupon, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_update_coupon(client, coupon, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_delete_coupon(client, coupon, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_batch_create_coupons(client, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_batch_update_coupons(client, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_batch_delete_coupons(client, params \\ %{}, opts \\ [])
```
