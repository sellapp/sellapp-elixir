...
```elixir
def replace(client, section, params \\ %{}, opts \\ [])
```
...
```elixir
def update(client, section, params \\ %{}, opts \\ [])
```
...
```elixir
def delete(client, section, opts \\ [])
```
...
```elixir
def replace_order(client, params \\ %{}, opts \\ [])
```
...
```elixir
def replace_products(client, section, params \\ %{}, opts \\ [])
```
...
```elixir
def replace_groups(client, section, params \\ %{}, opts \\ [])
```
...
```elixir
def v2_list_sections(client, params \\ %{}, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_list_sections(client, %{})
IO.inspect(result)
```
...
```elixir
def v2_create_section(client, params \\ %{}, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_create_section(client, %{"title" => "Founder resources", "hidden" => false})
IO.inspect(result)
```
...
```elixir
def v2_search_sections(client, params \\ %{}, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_search_sections(client, %{"filters" => [%{"field" => "id", "operator" => "=", "value" => 1}], "sort" => [%{"field" => "created_at", "direction" => "desc"}]})
IO.inspect(result)
```
...
```elixir
def v2_get_section(client, section, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_get_section(client, 1)
IO.inspect(result)
```
...
```elixir
def v2_replace_section(client, section, params \\ %{}, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_replace_section(client, 1, %{"title" => "Founder resources", "hidden" => false})
IO.inspect(result)
```
...
```elixir
def v2_update_section(client, section, params \\ %{}, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_update_section(client, 1, %{"title" => "Founder resources", "hidden" => false})
IO.inspect(result)
```
...
```elixir
def v2_delete_section(client, section, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_delete_section(client, 1)
IO.inspect(result)
```
...
```elixir
def v2_batch_create_sections(client, params \\ %{}, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_batch_create_sections(client, %{"resources" => [%{"title" => "Featured", "hidden" => false}]})
IO.inspect(result)
```
...
```elixir
def v2_batch_update_sections(client, params \\ %{}, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_batch_update_sections(client, %{"resources" => %{"1" => %{"title" => "Featured", "hidden" => false}}})
IO.inspect(result)
```
...
```elixir
def v2_batch_delete_sections(client, params \\ %{}, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_batch_delete_sections(client, %{"resources" => [1, 2]})
IO.inspect(result)
```
...
```elixir
def v2_replace_section_order(client, params \\ %{}, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_replace_section_order(client, %{"resources" => [3, 1, 2]})
IO.inspect(result)
```
...
```elixir
def v2_replace_section_products(client, section, params \\ %{}, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_replace_section_products(client, 1, %{"resources" => [3, 1, 2]})
IO.inspect(result)
```
...
```elixir
def v2_replace_section_groups(client, section, params \\ %{}, opts \\ [])
```
...
{:ok, result} = SellApp.Sections.v2_replace_section_groups(client, 1, %{"resources" => [3, 1, 2]})
IO.inspect(result)
```
