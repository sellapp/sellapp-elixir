...
defmodule SellApp.SearchRewardRulesRequestApplicationJsonPropertyFiltersItemType do
  @moduledoc """
  SearchRewardRulesRequestApplicationJsonPropertyFiltersItemType enum.
  """
