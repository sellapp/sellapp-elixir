...
defmodule SellApp.SearchTicketMessagesRequestApplicationJsonPropertyFiltersItemType do
  @moduledoc """
  SearchTicketMessagesRequestApplicationJsonPropertyFiltersItemType enum.
  """
