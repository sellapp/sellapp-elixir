...
defmodule SellApp.V2SearchTicketMessagesRequestApplicationJsonPropertyFiltersItemType do
  @moduledoc """
  V2SearchTicketMessagesRequestApplicationJsonPropertyFiltersItemType enum.
  """
