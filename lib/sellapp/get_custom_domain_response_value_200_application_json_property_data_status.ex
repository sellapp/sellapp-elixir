...
defmodule SellApp.GetCustomDomainResponseValue200ApplicationJsonPropertyDataStatus do
  @moduledoc """
  GetCustomDomainResponseValue200ApplicationJsonPropertyDataStatus enum.
  """
