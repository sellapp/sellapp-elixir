...
defmodule SellApp.SearchProductVariantsRequestApplicationJsonPropertyFiltersItemType do
  @moduledoc """
  SearchProductVariantsRequestApplicationJsonPropertyFiltersItemType enum.
  """
