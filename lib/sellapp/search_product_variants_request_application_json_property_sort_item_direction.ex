...
defmodule SellApp.SearchProductVariantsRequestApplicationJsonPropertySortItemDirection do
  @moduledoc """
  SearchProductVariantsRequestApplicationJsonPropertySortItemDirection enum.
  """
