...
defmodule SellApp.SearchProductsWithinGroupRequestApplicationJsonPropertyFiltersItemType do
  @moduledoc """
  SearchProductsWithinGroupRequestApplicationJsonPropertyFiltersItemType enum.
  """
