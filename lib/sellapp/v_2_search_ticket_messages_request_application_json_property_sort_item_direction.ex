...
defmodule SellApp.V2SearchTicketMessagesRequestApplicationJsonPropertySortItemDirection do
  @moduledoc """
  V2SearchTicketMessagesRequestApplicationJsonPropertySortItemDirection enum.
  """
