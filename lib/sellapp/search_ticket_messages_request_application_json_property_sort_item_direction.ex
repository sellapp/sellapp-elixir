...
defmodule SellApp.SearchTicketMessagesRequestApplicationJsonPropertySortItemDirection do
  @moduledoc """
  SearchTicketMessagesRequestApplicationJsonPropertySortItemDirection enum.
  """
