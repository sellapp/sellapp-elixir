...
defmodule SellApp.SearchCreditsProductsRequestApplicationJsonPropertySortItemDirection do
  @moduledoc """
  SearchCreditsProductsRequestApplicationJsonPropertySortItemDirection enum.
  """
