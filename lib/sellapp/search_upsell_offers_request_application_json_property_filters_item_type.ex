...
defmodule SellApp.SearchUpsellOffersRequestApplicationJsonPropertyFiltersItemType do
  @moduledoc """
  SearchUpsellOffersRequestApplicationJsonPropertyFiltersItemType enum.
  """
