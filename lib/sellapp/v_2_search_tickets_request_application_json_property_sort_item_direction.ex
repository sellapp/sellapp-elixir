...
defmodule SellApp.V2SearchTicketsRequestApplicationJsonPropertySortItemDirection do
  @moduledoc """
  V2SearchTicketsRequestApplicationJsonPropertySortItemDirection enum.
  """
